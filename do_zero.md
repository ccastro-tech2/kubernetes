...
Pod, menor unidade do kubernets - 
abstração: Uma caixa e nessa caixa posso por varios containers nela

ReplicaSets: é um objeto responsável por garantir a quantidade de pods em execução no nó;
Deployment: nosso controller do ReplicaSets responsavel pela saude dos pods 
parte 3 da aula 30 minutos.
